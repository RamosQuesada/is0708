...
else 
{
	...
	else
	{
		...
		$sql="select * from USUARIO,DEPARTAMENTOUSUARIO where USUARIO.NumVendedor=".$cod." and USUARIO.Password='".$pas."' AND DEPARTAMENTOUSUARIO.NumVendedor = USUARIO.NumVendedor";
		...
		else
		{
			...
			$_SESSION['departamento']=$reg['NombreDepartamento'];
