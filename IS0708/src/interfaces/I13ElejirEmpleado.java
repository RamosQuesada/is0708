...
public class I13ElejirEmpleado {
	...
	public I13ElejirEmpleado(Shell padre, ResourceBundle bundle, ArrayList<Empleado> empleados ) {
		...
		this.shell.setLocation(padre.getBounds().width/2 + padre.getBounds().x - shell.getSize().x/2, 
							   padre.getBounds().height/2 + padre.getBounds().y - shell.getSize().y/2);
}

	public void mostrarVentana() {
		
		icoPq = new Image(shell.getDisplay(), I01_Login.class.getResourceAsStream("icoPq.gif"));
		shell.setImage(icoPq);
		shell.setText(bundle.getString("Buscar"));
	...
	//NUMERO
		...
		lLNumero.setText(bundle.getString("I13_NumVendedor"));
		lBNumero.setText("->");
	//APELLIDO
		...
		lLApellido.setText(bundle.getString("Apellido"));
		lBApellido.setText("->");
	...
	//DEPT
		...
		lLDept.setText(bundle.getString("Departamento"));
		lBDept.setText("->");	
	...
	////Establecemos el grupoDER
		...
		bAdd.setText(bundle.getString("Añadir"));
		bCancel.setText(bundle.getString("Cancelar"));
		bRemove.setText(bundle.getString("Quitar"));
